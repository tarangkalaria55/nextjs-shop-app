export default function TermsPage() {
  return (
    <main className="container flex flex-col gap-4 self-center p-4 text-sm md:p-6">
      ...
      <p>
        This website is operated by Better Auth Starter. Throughout the site,
        the terms “we”, “us” and “our” refer to Better Auth Starter. Better Auth
        Starter offers this website, including all information, tools and
      ...
      <p>
        ...
        To view our Return Policy, please visit the Return Policy page.
      </p>
      ...
      <p>
        ...
        confidence; (2) to pay compensation for any comments; or (3) to respond
        to any comments. We may, but have no obligation to, monitor, edit or
        remove content that we determine in our sole discretion to be unlawful,
      ...
      <p>
        ...
        our Privacy Policy. To view our Privacy Policy, please see the Privacy
        Policy page.
      </p>
      ...
      <p>
        ...
        you are prohibited from using the site or its content for the following:
      </p>
      ...
      <p>
        You agree to indemnify, defend and hold harmless Better Auth Starter and
      ...
      <p>
        ...
        our website or the Service following the posting of any changes
